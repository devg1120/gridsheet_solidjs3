...
*/
  ...
  function panel_split_toggle() {
      const v  = document.querySelector("#ratio_v").value;
      const h1 = document.querySelector("#ratio_h1").value;
      const h2 = document.querySelector("#ratio_h2").value;
      split_ratio = [ v , h1, h2 ]
      console.log("panel_split_toggle", split_ratio);
...
*/
  return (
    <main>
      ...
      <input id="ratio_v"   type="number" style="width:60px; margin:0px 4px; text-align: center;" value="100" />
      <input id="ratio_h1"  type="number" style="width:60px; margin:0px 4px; text-align: center;" value="100" />
      <input id="ratio_h2"  type="number" style="width:60px; margin:0px 4px; text-align: center;" value="100" />
